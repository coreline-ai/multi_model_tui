...
import { ClaudeApiTransport } from "./transport-api.js";
import { ClaudeCliTransport } from "./transport-cli.js";
...
export class ClaudeAdapter implements ProviderAdapter {
  ...
  constructor(config: AppConfig) {
    this.transports = [new ClaudeApiTransport(config), new ClaudeCliTransport(config)];
  }
